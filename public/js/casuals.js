  ...
  col.innerHTML = `
    <div class="card shadow-sm card-button">
      ...
      <div class="card-body">
        ...
        <button class="btn btn-primary w-100" onclick="addCasual('${p._id}')">Add to Cart</button>
      </div>
    </div>
  `;
  return col;
...
// Load Casuals category
loadProducts("casuals");
